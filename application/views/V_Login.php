					...
					<div class="">
						...
						<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
							<div class="navbar-nav">
								<a class="nav-link active" aria-current="page" href="<?php echo base_url();?>">Login</a>
								<a class="nav-link" href="<?php echo base_url();?>register">Register User</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row d-flex justify-content-center">
					<div class="col-lg-4 col-md-4 col-sm-12">
						<div class="card card-body">
							...
							<div class="col-lg-12 col-md-12 col-sm-12">
								<form class="" id="user_login_form" action="<?php echo base_url();?>user/authentication" method="post" data-parsley-validate="true">
									<div class="form-group mt-2">
										<label for="">Email :  </label><br>
										<input type="text" class="form-control" name="email" value="" data-parsley-required="true">
									</div><br>
									<div class="form-group mt-2">
										<label for="">Password :  </label><br>
										<input type="password" class="form-control" name="password" value="" required data-parsley-length="[8,16]">
									</div><br>
									<div class="form-group mt-2">
										<input type="submit" class="btn btn-primary submit-user-login" name="" value="Login">
									</div>
								</form>
							</div>
						</div>
